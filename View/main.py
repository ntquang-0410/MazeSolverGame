...
class App:
    ...
    def draw_game(self):
        # jungle background full
        bg_scaled = pygame.transform.smoothscale(self.bg_jungle, (self.window_rect.w, self.window_rect.h))
        ...
        for r in range(MAZE_ROWS):
            for c in range(MAZE_COLS):
                if self.maze[r][c] == 1:
                    ...
                    tile = pygame.transform.smoothscale(self.tile_wall, (cell, cell))
                    self.screen.blit(tile, (x, y))
